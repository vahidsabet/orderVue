  ...
  methods: {
    ...
    getToken(){
      ...
      if(user){
         ...
         this.tokenStr=user.accessToken ;
          // console.log("u"+this.tokenStr); 
           return user.accessToken;
      }
         // this.tokenStr=(localStorage.getItem("user") != null) ? JSON.parse(localStorage.getItem("user")) : null;
       //  this.tokenStr=this.tokenStr.accessToken ;//console.log("token"+this.tokenStr.accessToken);
    },
